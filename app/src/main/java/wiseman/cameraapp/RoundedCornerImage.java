...
/**
 * Created by Wiseman on 2018-03-29.
 */

public class RoundedCornerImage extends AppCompatImageView {
    ...
    public RoundedCornerImage(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context,attrs,defStyleAttr);
    }*/
    @Override
